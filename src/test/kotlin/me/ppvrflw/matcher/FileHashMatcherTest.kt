...
class FileHashMatcherTest :
    FunSpec({
      context("insert and match") {
        ...
        test("match with realistic SHA-256 hash") {
          val sha256 = "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"
          val matcher =
              FileHashMatcher<String>().apply { insert(FileHashRecord.from(sha256), "empty-file") }

          matcher.match(FileHashRecord.from(sha256)) shouldBe listOf("empty-file")
        }
      }
